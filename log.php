...
<link rel="icon" href="includes/images/logo.png" type="image/x-icon">
    ...
    * {
        ...
        font-family: 'Manrope', sans-serif; /* Updated font family */
    }
...
.container:before {
  ...
  background-image: linear-gradient(-45deg, #000 0%, #878685 100%);
    ...
    <input type="submit" class="btn" value="Sign up" />
		...
		<div class="panels-container">
			<div class="panel left-panel">
				...
				<img  src="includes/images/signin.png" class="image" alt="" />
			</div>
			<div class="panel right-panel">
				...
				<img src="includes/images/signup.png"  class="image" alt="" />
			</div>
		</div>
	</div>
